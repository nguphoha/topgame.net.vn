...
package inet.util.json;

import inet.util.json.internal.ConstructorConstructor;
import inet.util.json.internal.Excluder;
import inet.util.json.internal.Primitives;
import inet.util.json.internal.Streams;
import inet.util.json.internal.bind.ArrayTypeAdapter;
import inet.util.json.internal.bind.CollectionTypeAdapterFactory;
import inet.util.json.internal.bind.DateTypeAdapter;
import inet.util.json.internal.bind.JsonTreeReader;
import inet.util.json.internal.bind.JsonTreeWriter;
import inet.util.json.internal.bind.MapTypeAdapterFactory;
import inet.util.json.internal.bind.ObjectTypeAdapter;
import inet.util.json.internal.bind.ReflectiveTypeAdapterFactory;
import inet.util.json.internal.bind.SqlDateTypeAdapter;
import inet.util.json.internal.bind.TimeTypeAdapter;
import inet.util.json.internal.bind.TypeAdapters;
import inet.util.json.reflect.TypeToken;
import inet.util.json.stream.JsonReader;
import inet.util.json.stream.JsonToken;
import inet.util.json.stream.JsonWriter;
import inet.util.json.stream.MalformedJsonException;
 ...
 * </p>
 * 
 * @see inet.util.json.reflect.TypeToken
 * 
...
public final class Json {
	 ...
	 * {@link inet.util.json.annotations.Expose} annotation. You can enable Gson
	 * to serialize/deserialize only those fields marked with this annotation
	 * through {@link GsonBuilder#excludeFieldsWithoutExposeAnnotation()}.</li>
	 * <li>By default, Gson ignores the {@link inet.util.json.annotations.Since}
	 ...
	 *            by using the {@link inet.util.json.reflect.TypeToken} class.
