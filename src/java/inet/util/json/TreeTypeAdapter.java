...
import inet.util.json.internal.$Gson$Preconditions;
...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
  ...
  @Override public T read(JsonReader in) throws IOException {
    ...
    return deserializer.deserialize(value, typeToken.getType(), json.deserializationContext);
  }
  ...
  @Override public void write(JsonWriter out, T value) throws IOException {
    ...
    JsonElement tree = serializer.serialize(value, typeToken.getType(), json.serializationContext);
