 ...
 *
 * <p>This annotation has no effect unless you build {@link inet.util.json.Json}
 * with a {@link inet.util.json.GsonBuilder} and invoke
 * {@link inet.util.json.GsonBuilder#excludeFieldsWithoutExposeAnnotation()}
 * method.</p>
 *
